function Player(game, spawn){
	...
	// Enable physics before accessing body
...
Player.prototype.update = function(){
	...
	if(GUIManager.menuScreen.visible == false){
		...
		// Mobile joystick movement override
		if (typeof isMobile === 'function' && isMobile() && window.moveDirection) {
			this.body.velocity.x = window.moveDirection.x * this.speed;
			this.body.velocity.y = window.moveDirection.y * this.speed;
		} else {
